...
export const INTENTS = {
  ...
  install_scheduled:   { primary_user_slugs: ['aj'], primary_roles: ['admin'], one_liner_template: '{operator} scheduled an install for {customer}. Details: "{operator_msg}"' },
  install_reschedule:  { primary_user_slugs: ['aj'], primary_roles: ['admin'], one_liner_template: '{customer} is rescheduling. Originator: {operator}. Details: "{operator_msg}"' },
  material_request:    { primary_user_slugs: ['aj'], primary_roles: ['admin'], one_liner_template: '{operator} needs materials. Details: "{operator_msg}"' },
  crew_dispatch_change:{ primary_user_slugs: ['aj'], primary_roles: ['admin'], one_liner_template: '{operator} flagged a crew dispatch change. Details: "{operator_msg}"' },
  paysheet_question:   { primary_user_slugs: ['aj'], primary_roles: ['admin'], one_liner_template: '{operator} has a paysheet question. Details: "{operator_msg}"' },
  equipment_issue:     { primary_user_slugs: ['aj'], primary_roles: ['admin'], one_liner_template: '{operator} flagged an equipment issue. Details: "{operator_msg}"' },

  repair_request:      { primary_user_slugs: ['diego'], primary_roles: ['admin'], one_liner_template: 'Repair request for {customer}. Originator: {operator}. Details: "{operator_msg}"' },
  color_dropoff:       { primary_user_slugs: ['diego'], primary_roles: ['admin'], one_liner_template: '{customer} is dropping by for samples / pickup. Originator: {operator}. Details: "{operator_msg}"' },
  inspection_request:  { primary_user_slugs: ['diego'], primary_roles: ['admin'], one_liner_template: 'Inspection request for {customer}. Originator: {operator}. Details: "{operator_msg}"' },
  ...
  warranty_claim:      { primary_user_slugs: ['aj'], primary_roles: ['admin'], one_liner_template: 'Warranty claim flagged for {customer}. Originator: {operator}. Details: "{operator_msg}"' },

  supplier_order:      { primary_roles: ['admin'], one_liner_template: 'Supplier order needed. Originator: {operator}. Details: "{operator_msg}"' },

    ...
    if (!p || !p.lineItems || p.lineItems.length === 0) {
      ...
      <div style="max-width:800px;margin:0 auto;padding:40px 24px">
        <div style="text-align:center;margin-bottom:40px">
          ...
          <h2 style="font-family:'Montserrat',sans-serif;font-size:2.4em;font-weight:900;color:#fff;margin-bottom:8px">${esc(sp.totalFormatted || '$' + (sp.totalRaw||0).toLocaleString())}</h2>
          <div style="font-size:1em;color:rgba(255,255,255,0.5)">${esc(packageName)} Package &bull; HST included</div>
        </div>

...
export function renderProposalHTML(proposal) {
  ...
  // ═══ SLIDE 9.5: TESTIMONIAL ═══
  html += `<div style="max-width:650px;margin:0 auto;padding:60px 24px;text-align:center">
    <div style="font-size:1.3em;color:rgba(255,255,255,0.15);font-family:Georgia,serif;margin-bottom:8px">&ldquo;</div>
    <p style="font-size:1.1em;line-height:1.85;color:rgba(255,255,255,0.7);font-style:italic">Professional crew, clean job site, excellent communication throughout. The whole process was smooth from the first estimate to the final walkthrough. Would definitely recommend to anyone in the area.</p>
    <div style="margin-top:16px;font-size:0.85em;color:rgba(255,255,255,0.4);font-weight:600">— Recent Customer, ${new Date().getFullYear()}</div>
  </div>`;

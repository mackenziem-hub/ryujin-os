...
export function renderSalesPageHTML(salesData) {
  ...
  <div class="video-wrap">
    <div class="video-card">
      ${introVideo ? `<video controls playsinline poster="" preload="metadata" style="width:100%;display:block;border-radius:16px">
        <source src="${esc(introVideo)}" type="video/mp4">
      </video>` : `<div class="video-placeholder">
  ...
  <div id="proposal" style="scroll-margin-top:20px">
  ${(() => {
    const p = s._proposalData;
    if (!p || !p.lineItems || p.lineItems.length === 0) return '';
    return `

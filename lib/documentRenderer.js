...
export function renderSalesPageHTML(salesData) {
  ...
  <div class="cta-section">
    ...
    <div class="sub">Your complete ${esc(packageName)} proposal is ready — with pricing, materials, and warranty details.</div>
    <a href="#" class="cta-btn" id="viewProposalBtn">View Your Proposal</a>
  ...
  <!-- Hidden proposal data for the CTA button to use -->
  ...
  <!-- Script: CTA opens proposal in new tab -->
  <script>
  (function(){
    var proposalHTML = document.getElementById('proposalHTML');
    var btn = document.getElementById('viewProposalBtn');
    if (btn && proposalHTML) {
      btn.addEventListener('click', function(e) {
        e.preventDefault();
        var html = decodeURIComponent(proposalHTML.getAttribute('data-html'));
  ...
  // If we have proposal data, render the full proposal HTML and embed it
  if (s._proposalData) {
    const proposalHTML = renderProposalHTML(s._proposalData);
    const encoded = encodeURIComponent(proposalHTML);
    html = html.replace('id="proposal" style="display:none"', 'id="proposal" style="display:none"><div id="proposalHTML" data-html="' + encoded + '"');
  }

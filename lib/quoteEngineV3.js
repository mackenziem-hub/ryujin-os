...
export async function calculateQuoteV3(supabase, {
  ...
  // Per pricing_formula_v2.md Section 1+3+5: multipliers are fixed by package (1.47/1.52/1.58).
  // Distance is handled as a LABOR adder (Section 5), NOT a multiplier bump.

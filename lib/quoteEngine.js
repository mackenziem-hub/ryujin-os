...
const DIAMOND_MATERIALS = {
  shingles:      { price: 90, bundlesPerSQ: 6, desc: 'CertainTeed Presidential @ $90/bundle x 6 (triple-laminate, 6 bdl/SQ)' },
  underlayment:  { price: 167, coverageSQ: 10, desc: 'Premium synthetic @ $167/roll (10 SQ)' },
  iceAndWater:   { price: 178, coverageSQ: 2, desc: 'Grace I&W @ $178/roll (2 SQ)' }
};
...
const METAL_PANELS = {
  americana: { rate: 3.64, unit: 'sqft', desc: 'Americana ribbed @ $3.64/sqft (ARF +30% Jun 2026)', strapping: 45 },
  standingSeam: { rate: 7.80, unit: 'sqft', desc: 'Standing seam @ $7.80/sqft (ARF +30% Jun 2026, verify with supplier)' }
};

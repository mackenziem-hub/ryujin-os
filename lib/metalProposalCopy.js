...
const FLAT_PANEL = {
  rank: 'designer',
  tag: 'METAL OPTION',
  name: 'Flat Panel Exposed Fastener',
  subtitle: 'Classic steel panel, installed over your existing roof',
  toggleLabel: 'Flat Panel',
  warrantyYears: 15,
  warrantyLabel: 'Lifetime panel warranty · 15-year workmanship',
  bullets: [
    'Lifetime panel warranty',
  ...
  bestFit: 'The proven workhorse profile. Same steel-roof service life in a clean flat panel, at a sharper price.'
};

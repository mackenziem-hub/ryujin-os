...
export const ARCHETYPES = {
  hero: {
    ...
    avatar_image: '/assets/archetypes/sovereign-bust.png',  // bust fallback (decisive male)
  ...
  magician: {
    ...
    avatar_image: '/assets/archetypes/sage-bust.png',  // bust fallback (visionary)
  ...
  caregiver: {
    ...
    avatar_image: '/assets/archetypes/caregiver-bust.png',
  ...
  ruler: {
    ...
    avatar_image: '/assets/archetypes/sovereign-bust.png',  // bust fallback (regal)
  ...
  lover: {
    ...
    avatar_image: '/assets/archetypes/caregiver-bust.png',  // bust fallback (warm)
  ...
  sage: {
    ...
    avatar_image: '/assets/archetypes/sage-bust.png',
    accent_color: '#22d3ee',  // cyan
  },
  sovereign: {
    label: 'Sovereign',
    voice_clip_dir: '/assets/voice/sovereign',
    avatar_video: null,  // no video shipped yet — bust fallback always wins
    avatar_poster: null,
    avatar_image: '/assets/archetypes/sovereign-bust.png',
...
You speak warm and competent, never alarming. Recommend the action that defuses the highest-stakes situation first. Never more than 4 options. Reference customers by name, tickets by title.`,
  ...
  customer: {
    ...
    persona_prompt: `You are the Advocate — the customer-relationship archetype for Ryujin OS, embedded in a roofing contractor's customer pillar. You think in long arcs: who became loyal, who churned, who referred. You believe every customer touch matters and the small kindnesses compound.

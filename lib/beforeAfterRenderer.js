...
<svg xmlns="http://www.w3.org/2000/svg" width="${width}" height="${height}" viewBox="0 0 ${width} ${height}">
  ...
  <text x="130" y="${badgeY + badgeH / 2 + 10}" font-family="Arial, sans-serif" font-size="${badgeFontSize}" font-weight="800" letter-spacing="3" fill="${brandColor}" stroke="#000" stroke-width="3" paint-order="stroke" text-anchor="middle">BEFORE</text>

  <!-- AFTER label -->
  <text x="${halfW + 120}" y="${badgeY + badgeH / 2 + 10}" font-family="Arial, sans-serif" font-size="${badgeFontSize}" font-weight="800" letter-spacing="3" fill="#4ade80" stroke="#000" stroke-width="3" paint-order="stroke" text-anchor="middle">AFTER</text>
  ...
  <text x="${width - 120}" y="${badgeY + 22}" font-family="Arial, sans-serif" font-size="16" font-weight="800" letter-spacing="3" fill="#ffffff" stroke="#000" stroke-width="2.5" paint-order="stroke" text-anchor="middle">PLUS ULTRA</text>
  <text x="${width - 120}" y="${badgeY + 38}" font-family="Arial, sans-serif" font-size="11" font-weight="700" letter-spacing="3" fill="${brandColor}" stroke="#000" stroke-width="2" paint-order="stroke" text-anchor="middle">ROOFING</text>
</svg>`;

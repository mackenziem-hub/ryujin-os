...
// ── Token verification ──────────────────────────────────────────
// Implementation lives in lib/sub-auth.js so /api/job-log-photo (and any
// future endpoint that needs to authenticate the same token) can reuse it.
// Kept as a local alias to minimize the diff and preserve existing callsites.
const verifyToken = verifySubToken;
